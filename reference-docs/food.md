...
## [Actions](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#actions)

The `manage_food` tool supports the following actions:

### [`search_food`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#search_food)
...
### [`log_food`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#log_food)
...
### [`create_food`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#create_food)
...
### [`search_meal`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#search_meal)

-   **Description:** Search for existing meal templates.
-   **Parameters:**
    -   `meal_name` (string): The name of the meal template to search for.

### [`log_meal`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#log_meal)
...
### [`list_diary`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#list_diary)
...
### [`delete_entry`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#delete_entry)

-   **Description:** Deletes a specific food or meal entry from the diary.
-   **Parameters:**
    -   `entry_id` (string): UUID of the entry to delete.
    -   `entry_type` (enum: "food\_entry", "food\_entry\_meal"): The type of entry.

### [`update_entry`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#update_entry)
...
### [`copy_from_yesterday`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#copy_from_yesterday)
...
### [`save_as_meal_template`](https://codewithcj.github.io/SparkyFitness/developer/mcp/dev#save_as_meal_template)
